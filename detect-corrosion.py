...
def run(
    ...
    classes=[0, 39],  # filter by class: --class 0, or --class 0 2 3
    ...
    deteksi = {"corroded-part": 0, "mild-corrosion": 0, "moderate-corrosion": 0, "severe-corrosion": 0}
    is_detect = 0
    c = 0
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                is_detect = True  # untuk counting deteksi
                # Write results
                ...
                is_detect = False  # untuk stop counting deteksi
            # Ubah nama Dictionary
            output_string = ""
            for key, value in deteksi.items():
            ...
            if (
                is_detect
            ):  # fungsi untuk mengentikan perhitunkan object sesuai dengan kondisi
                deteksi[names[int(c)]] += 1
            else:
                deteksi[names[int(c)]] == 0
